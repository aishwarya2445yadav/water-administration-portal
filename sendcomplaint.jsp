...
<li><a href="employee.html" class="page-scroll">Logout</a></li>
      </ul>
    </div>
    <!-- /.navbar-collapse --> 
  </div>
    ...
    <div class="overlay">
      <div class="container">
        <div class="row">
         ...
         <h2>Welcome Citizen,<%= session.getAttribute("UserName") %></h2><br>
		<table align="center" width=40% style="font-size:25px;color:white;">
<tr><td align="center" colspan=2>Send Complaint</td></tr>
<form action="sendcomplaint1.jsp" method="post">
<tr><th>Zone </th><th><select name="zone" style="color:black;">
			  <option value="Zone1">Zone1
			  <option value="Zone2">Zone2
			  <option value="Zone3">Zone3
			  <option value="Zone4">Zone4
			</select></th></tr>
<tr><th>Area </th><th><input type="text" name="area" style="color:black;" required></textarea></th></tr>
<tr><th>Query</th><th><textarea rows=5 cols=20 name="query" style="color:black;"></textarea></th></tr>
<tr>
  <th><input type="submit" value="Send Request" style="color:black;"/></th>
  <th><input type="reset" value="Reset" style="color:black;"/></th>
</tr>
</form>
<tr><td align="Center" colspan=2><a href="citizenhome.jsp">Back</a></td></tr>
		</table>
        </div>
      </div>
    </div>
