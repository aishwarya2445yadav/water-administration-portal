    ...
    <div class="overlay">
      <div class="container">
		...
		<table align="center" width=50% style="font-size:22px;">
		  <form action="addzone1.jsp" method="post">
	<tr><td align="center" colspan=2>Add Zones</td></tr>
			...
			<tr><th>Areas </th><th><textarea rows=5 cols=25 style="color:black;" name="areas">
			</textarea></th></tr>
			<tr>
			<th><input type="Submit" value="AddZone" style="color:black;"/></th>
