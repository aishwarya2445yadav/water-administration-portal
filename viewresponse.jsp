...
<header id="header">
  <div class="intro text-center">
    <div class="overlay">
     ...
     <tr><td colspan=9 align="center">User Requests
	 </td></tr>
	<tr><th>CitizenName<th>Zone</th><th>Area</th><th>Query</th><th>Request Date</th><th>Response</th><th>Responded by</th><th>Response Date</th><th>Status</th></tr>
	<%@include file="DBConn.jsp" %>
	<%
PreparedStatement pst=con.prepareStatement("Select * from userqueries");
