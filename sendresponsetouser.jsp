...
<tr><td align="center" colspan=2>Send Response</td></tr>
<form action="sendresponsetouser1.jsp" >
<tr><th>Response</th><th><textarea rows=5 cols=20 name="response" style="color:black;"></textarea></th></tr>
<tr><th>Request ID</th><th><input type="text" required style="color:black;" value="<%= request.getParameter("reqid")%>" name="reqid"/> </th></tr>
<tr>
  <th><input type="submit" value="Send Response" style="color:black;"/></th>
