...
<header id="header">
    ...
    <div class="overlay">
      <div class="container">
        <div class="row">
         ...
         <h2>Welcome User,<%= session.getAttribute("UserName") %></h2><br>
		<table align="center" style="font-size:20px;" border=4 width=100%>
     <tr><td colspan=8 align="center">View Response</td></tr>
	<tr><th>Zone</th><th>Area</th><th>Query</th><th>Request Date</th><th>Response</th><th>Responded by</th><th>Response Date</th><th>Status</th></tr>
	<%@include file="DBConn.jsp" %>
	<%
	String user=(String)session.getAttribute("UserName");
  PreparedStatement pst=con.prepareStatement("Select * from userqueries where citizenname=?");
  ...
  while(rs.next())
  {
	  ...
	  if(status == 0)
		   res = "Pending at Admin";
	  else if(status == 1)
		   res = "Pending at Employee";
	  else if(status == 2)
		    res = "Request Closed";
     ...
     <tr>
	   ...
	   <th><%= rs.getString(9) %></th><th><%= res %></th>
	 </tr>
  <%}
	%>
	<tr><td align="center" colspan=8><a href="citizenhome.jsp">Back</a></td></tr>
	</table>
