...
<header id="header">
  <div class="intro text-center">
    <div class="overlay">
      <div class="container">
		...
		<table align="center" style="font-size:20px;" border=4 width=70%>
     <tr><td colspan=6 align="center">City Water Timings</td></tr>
	<tr><th>Id</th><th>Employee Name</th><th>Zone </th><th>StartTime</th><th>End Time</th><th>Areas</th></tr>
	<%@include file="DBConn.jsp" %>
	<%
  PreparedStatement pst=con.prepareStatement("Select * from watertimings");
  ...
  <%}
	%>
	<tr><td align="center" colspan=6><a href="citizenhome.jsp">Back</a></td></tr>
	</table>
        </div>
      </div>
    </div>
