...
<header id="header">
  <div class="intro text-center">
    <div class="overlay">
     ...
     <tr><td colspan=7 align="center">City Water details</td></tr>
	<tr><th>Id</th><th>Bacteria Level</th><th>Contamination Level</th><th>Instructions</th><th>Employee Name</th><th>Zone</th><th>Updated On</th></tr>
	<%@include file="DBConn.jsp" %>
	<%
  PreparedStatement pst=con.prepareStatement("Select * from waterdetails");
  ...
  <%}
	%>
	<tr><td align="center" colspan=7><a href="citizenhome.jsp">Back</a></td></tr>
	</table>
        </div>
      </div>
    </div>
