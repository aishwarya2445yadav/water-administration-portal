    ...
    <div class="overlay">
      <div class="container">
        <div class="row">
         ...
         <h2 style="font-size:35px;color:white;">Welcome Employee,<%= session.getAttribute("UserName") %></h2><br>
		 <%@include file="DBConn.jsp" %>
			<%
                          
			  String query="select count(status) from userqueries where status=1 and zone = '"+session.getAttribute("ZONE")+"'";
        ...
        <tr><th><a href="addwaterdetails.jsp" style="font-size:25px;color:white;">Add Water Details</a></th></tr>
		<tr><th><a href="addtimings.jsp" style="font-size:25px;color:white;">Add Timings</a></th></tr>
		<tr><th><a href="userrequests1.jsp" style="font-size:25px;color:white;">User Requests(<%= count %>)</a></th></tr>
		<tr><th><a href="viewfeedback1.jsp" style="font-size:25px;color:white;">View Feedback</a></th></tr>
		<tr><th><a href="employee.html" style="font-size:25px;color:white;">Logout</a></th></tr>
		</table>
