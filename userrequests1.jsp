...
<header id="header">
  <div class="intro text-center">
	...
	<table align="center" style="font-size:20px;" border=4 width=100%>
     <tr><td colspan=6 align="center">User Complaints</td></tr>
	<tr><th>Citizen Name</th><th>Zone </th><th>Area</th><th>Query</th><th>Date</th><th>Operation</th></tr>
	<%@include file="DBConn.jsp" %>
	<%
	String zone=(String)session.getAttribute("ZONE");
  PreparedStatement pst=con.prepareStatement("Select * from userqueries where status=1 and zone=?");
...
<th><a href="sendresponsetouser.jsp?reqid=<%= rs.getString(1) %>">Send Response</a></th>
	 </tr>
  <%}
	%>
	<tr><td align="center" colspan=6><a href="employeehome.jsp">Back</a></td></tr>
	</table>
