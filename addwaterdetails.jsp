    ...
    <div class="overlay">
      <div class="container">
        <div class="row">
         ...
         <h2>Welcome Employee,<%= session.getAttribute("UserName") %></h2><br>
		<table align="center" width=50% style="font-size:25px;color:white;">
<tr><td align="center" colspan=2>Enter Water Details</td></tr>
<form action="addwaterdetails1.jsp" method="post">
<tr><th>Bacteria Level(%)</th><th><input type="number" name="blevel" required style="color:black;" /></th></tr>
<tr><th>Contaminationlevel(%) </th><th><input type="number" name="clevel" required style="color:black;" /></th></tr>
<tr><th>Instructions</th><th><textarea rows=5 cols=24 name="instrutions" style="color:black;">
</textarea></th></tr>
<tr>
  <th><input type="submit" value="Add Water Details" style="color:black;"/> </th>
  <th><input type="reset" value="Reset" style="color:black;"/></th>
</tr>
</form>
<tr><td align="Center" colspan=2><a href="employeehome.jsp">Back</a></td></tr>
