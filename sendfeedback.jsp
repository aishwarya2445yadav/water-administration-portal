...
<tr><td align="center" colspan=2>Send feedback</td></tr>
<form action="sendfeedback1.jsp" method="post">
<tr><th>Enter Feedback</th><th><textarea rows=5 cols=20 name="feedback" style="color:black;"></textarea></th></tr>
<tr><th>Rating(1 to 10)</th><th><input type="number" name="rating" min=1 max=10  required style="color:black;"/></th></tr>
<tr>
  <th><input type="submit" value="Send Feedback" style="color:black;"/></th>
