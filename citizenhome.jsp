    ...
    <div class="overlay">
      <div class="container">
        <div class="row">
         ...
         <h2 style="font-size:35px;color:white;">Welcome User,<%= session.getAttribute("UserName") %></h2><br>
		<table align="center" style="font-size:25px;">
        <tr><th><a href="viewwaterdetails.jsp" style="font-size:25px;color:white;">View Water Details</a></th></tr>
		<tr><th><a href="viewtimings.jsp" style="font-size:25px;color:white;">View Timings</a></th></tr>
		<tr><th><a href="sendcomplaint.jsp" style="font-size:25px;color:white;">Send Query</a></th></tr>
<tr><th><a href="viewuserresponse.jsp" style="font-size:25px;color:white;">View Response</a></th></tr>
		<tr><th><a href="sendfeedback.jsp" style="font-size:25px;color:white;">Send Feedback</a></th></tr>
		<tr><th><a href="citizen.html" style="font-size:25px;color:white;">Logout</a></th></tr>
		</table>
